            ...
            [
                {
                    ...
                    "total_area_ha": 10,
                    "total_yield_production_kg": 10000,
                    "total_yield_production_ton": 10.0,
                    "apsim_mean_yield_estimate_kg_ha": 900,
                },
                {
                    "county": "A",
                    "mean_yield_kg_ha": 2000,
                    "total_area_ha": 10,
                    "total_yield_production_kg": 20000,
                    "total_yield_production_ton": 20.0,
            ...
            [
                {
                    ...
                    "mean_yield_kg_ha": 1000,
                    "total_area_ha": 90,
                    "total_yield_production_kg": 90000,
                    "total_yield_production_ton": 90.0,
                    "apsim_mean_yield_estimate_kg_ha": 900,
                },
                {
                    "county": "A",
            ...
            [
                {
                    ...
                    "mean_yield_kg_ha": 1000,
                    "total_area_ha": 50,
                    "total_yield_production_kg": 50000,
                    "total_yield_production_ton": 50.0,
                    "apsim_mean_yield_estimate_kg_ha": 900,
                },
                {
                    "county": "A",
                    "mean_yield_kg_ha": 2000,
                    "total_area_ha": 30,
                    "total_yield_production_kg": 60000,
                    "total_yield_production_ton": 60.0,
                    "apsim_mean_yield_estimate_kg_ha": 1800,
                },
            ]
        )
    ...
    def test_weighted_median_two_equal_weights(self):
        ...
        df = _make_estimation_df(
            [
                ...
                {
                    "county": "A",
                    "mean_yield_kg_ha": 3000,
                    "total_area_ha": 50,
                    "total_yield_production_kg": 150000,
                    "total_yield_production_ton": 150.0,
        ...
        df = _make_estimation_df(
            [
                ...
                },
                {
                    ...
                    "mean_yield_kg_ha": 3000,
                    "total_area_ha": 90,
                    "total_yield_production_kg": 270000,
                    "total_yield_production_ton": 270.0,
                    "apsim_mean_yield_estimate_kg_ha": 2700,
                },
            ]
        )
            ...
            [
                {
                    ...
                    "mean_yield_kg_ha": 1000,
                    "total_area_ha": 30,
                    "total_yield_production_kg": 30000,
                    "total_yield_production_ton": 30.0,
                    "apsim_mean_yield_estimate_kg_ha": 900,
                },
                {
                    "county": "A",
                    "mean_yield_kg_ha": 2000,
                    "total_area_ha": 40,
                    "total_yield_production_kg": 80000,
                    "total_yield_production_ton": 80.0,
                    "apsim_mean_yield_estimate_kg_ha": 1800,
                },
                {
                    "county": "A",
                    "mean_yield_kg_ha": 5000,
                    "total_area_ha": 30,
                    "total_yield_production_kg": 150000,
                    "total_yield_production_ton": 150.0,
        ...
        df = _make_estimation_df(
            [
                ...
                },
                {
                    ...
                    "mean_yield_kg_ha": 2000,
                    "total_area_ha": 20,
                    "total_yield_production_kg": 40000,
                    "total_yield_production_ton": 40.0,
                    "apsim_mean_yield_estimate_kg_ha": 1800,
                },
            ]
        )
...
class TestWeightedAggregationEndToEnd:
        ...
        df = _make_estimation_df(
            [
                ...
                # Large region: 100 ha, low yield
                {
                    ...
                    "mean_yield_kg_ha": 1000,
                    "total_area_ha": 100,
                    "total_yield_production_kg": 100000,
                    "total_yield_production_ton": 100.0,
                    "apsim_mean_yield_estimate_kg_ha": 900,
                },
            ]
        )
            ...
            [
                {
                    ...
                    "mean_yield_kg_ha": 5000,
                    "total_area_ha": 1,
                    "total_yield_production_kg": 5000,
                    "total_yield_production_ton": 5.0,
                    "apsim_mean_yield_estimate_kg_ha": 4500,
                },
                {
                    "state": "TX",
                    "mean_yield_kg_ha": 1000,
                    "total_area_ha": 99,
                    "total_yield_production_kg": 99000,
                    "total_yield_production_ton": 99.0,
                    "apsim_mean_yield_estimate_kg_ha": 900,
                },
            ]
        )
    ...
    def test_single_region_weighted_mean_equals_input(self):
        ...
        df = _make_estimation_df(
            [
                {
                    "state": "NY",
                    "mean_yield_kg_ha": 3456,
                    "total_area_ha": 42,
                    "total_yield_production_kg": 145152,
                    "total_yield_production_ton": 145.152,
    ...
    def test_total_production_independent_of_weighting(self):
        ...
        df = _make_estimation_df(
            [
                ...
                {
                    "state": "CA",
                    "mean_yield_kg_ha": 4000,
                    "total_area_ha": 50,
                    "total_yield_production_kg": 200000,
                    "total_yield_production_ton": 200.0,
            ...
            [
                {
                    ...
                    "mean_yield_kg_ha": 2000,
                    "total_area_ha": 80,
                    "total_yield_production_kg": 160000,
                    "total_yield_production_ton": 160.0,
                    "apsim_mean_yield_estimate_kg_ha": 1800,
                },
                {
                    "state": "KS",
    ...
    def test_negative_area_corrupts_weighting(self):
            ...
            [
                {
                    ...
                    "mean_yield_kg_ha": 0,
                    "total_area_ha": -1,
                    "total_yield_production_kg": 0,
                    "total_yield_production_ton": 0.0,
                ...
                },
                {
                    ...
                    "mean_yield_kg_ha": 3000,
                    "total_area_ha": 100,
                    "total_yield_production_kg": 300000,
                    "total_yield_production_ton": 300.0,
                    "apsim_mean_yield_estimate_kg_ha": 2700,
                },
            ]
        )
        ...
        wm = result["mean_yield_kg_ha"].iloc[0]
        assert wm != pytest.approx(3000.0, abs=1.0), "If this passes, the -1 sentinel is no longer causing issues"
